...
from routers import auth, user, roles, verify, career_type_router, admin_panel_user_management
...
app.include_router(admin_panel_user_management.router, prefix="/admin_panel", tags=["admin_panel"])